...
func main() {
	...
	val := 5
	log.Println("二叉搜索树中的插入-递归法:", levelorder.TraversalRecursive(insertIntoBST(searchNode, val)))
	log.Println("二叉搜索树中的插入-迭代法:", levelorder.TraversalRecursive(insertIntoBST1(searchNode, val)))
}
